...
render() {\
return html `<div class="p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow"> <img src=${this.icon} alt="icon" class="w-12 h-12 mb-4"> <h3 class="text-xl font-semibold mb-2">${this.title}</h3> <p class="text-gray-600">${this.description}</p> </div>` ;\
}\
}\
Styling:\
