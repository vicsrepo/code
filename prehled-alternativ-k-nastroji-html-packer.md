...
**Co to je:**\
&#xNAN;_&#x4E;ástroj_, který přečte HTML soubor, najde tagy jako `<script>`, `<link>` a `<img>` a nahradí odkazy obsahem (např. vloží obsah CSS a JS přímo do stránky nebo zakóduje obrázek do base64).
