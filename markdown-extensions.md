...
VitePress also supports [GitHub-flavored alerts](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#alerts) to render as callouts. They will be rendered the same as the [custom containers](broken-reference).
...
It also supports [line highlighting](broken-reference):
...
You can also [import snippets](broken-reference) in code groups:
